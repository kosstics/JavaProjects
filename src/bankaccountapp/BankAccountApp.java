...
public class BankAccountApp {
	...
	List<Account> accounts= new LinkedList<Account>();
		...
		/*
		 * Checking chkacc1= new Checking("Snežana Kostiæ", "321456879", 1500);
		 * Savings savacc1 = new Savings("Miloš Kostiæ", "456657897", 2500);
		...
		String file = "C:\\Users\\Snežana\\workspace\\JavaProjects\\NewBankAccounts.csv";
